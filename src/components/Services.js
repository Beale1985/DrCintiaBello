        ...
        <section className="page-section" id="services">
            <div className="container">
                ...
                <div className="row text-center">
                    <div className="col-md-4">
                        ...
                        <Zoom>
                        <p className="text-muted">Contactanos por whatsapp para reservar una entrevista médica.</p>
                        </Zoom>
                    </div>
                    <div className="col-md-4">
                    ...
                    <div className="col-md-4">
                        ...
                        <Zoom>
                        <p className="text-muted">Se agendan los turnos para empezar el tratamiento.</p>
                        </Zoom>
                    </div>
                </div>
            </div>
            <div className="row justify-content-start">
                ...
                <div className="col-md-1 a">
                    <Shake>
                <div id="whatsapp">
                    <a href="https://api.whatsapp.com/send/?phone=541169559766" target="_blank">
                        <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="whatsapp" class="svg-inline--fa fa-whatsapp fa-w-14" style={{width:"60px", height:"60px"}} role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
