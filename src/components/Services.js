            ...
            <div className="container">
                ...
                <div className="row text-center">
                    ...
                    <div className="col-md-4">
                        ...
                        <Zoom>
                        <p className="text-muted">En la entrevista médica con la Dr. Cintia Bello se evaluará cual es es mejor tratamiento a realizar.</p>
                        </Zoom>
                    </div> 
                    <div className="col-md-4">
                        <span className="fa-stack fa-4x" style={{color:"rgb(85,98,112)"}}>
            ...
            <div className="row justify-content-start">
                ...
                <div id="whatsapp">
                    <a href="https://api.whatsapp.com/send/?phone=541169559766" target="_blank">
                        <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="whatsapp" class="svg-inline--fa fa-whatsapp fa-w-14 icono-whatsapp" style={{width:"60px", height:"60px"}} role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
