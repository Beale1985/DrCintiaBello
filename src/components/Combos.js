...
function Combos() {
  return (
    <div className='container'>
        <br/>
        <div>
            <h4 className='text-center textoConsulta' style={{paddingTop:"100px"}} id="inicio">Antes de comenzar el tratamiento se debe realizar una evaluación médica sin cargo con la Dra. Cintia Bello.</h4>
        </div>
        <div className="row">
